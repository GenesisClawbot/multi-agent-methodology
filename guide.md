...
Copy these, adapt them to your project, and you have the core scaffolding. The hard part isn't setting this up — it's maintaining the discipline to use it consistently. Every shortcut you take ("I'll just have this agent update the shared file directly, just this once") is a failure mode waiting to happen.
